...
// Wenn der Bag leer ist --> redirect
if(empty($_SESSION['bag'])){
  redirect_to("index.php?site=bag");
}

// Wenn der User nicht eingeloggt ist --> redirect
if(!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] == false){
  redirect_to("index.php?site=checkout&action=login-checkout");
}

// Shippinginformation auf false setzen (Falls der Checkoutschritt nochmal durchlaufen wird)
